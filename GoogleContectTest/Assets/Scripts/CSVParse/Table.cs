...
//        mpCost = Convert.ToSingle(inputData[count++]);
//        imageName = inputData[count++];
//        description = inputData[count++];
//        active_Time = 0.0f;
//    }
...
//public class _Temp_Table_ItemStat
//{
//    public readonly int num;
//    public readonly int[] statPerLevel = new int[9];

//    public _Temp_Table_ItemStat(string[] inputData)
//    {
//        num = Convert.ToInt32(inputData[0]);
//        statPerLevel[0] = Convert.ToInt32(inputData[4]);
//        statPerLevel[1] = Convert.ToInt32(inputData[5]);
//        statPerLevel[2] = Convert.ToInt32(inputData[6]);
//        statPerLevel[3] = Convert.ToInt32(inputData[7]);
//        statPerLevel[4] = Convert.ToInt32(inputData[8]);
//        statPerLevel[5] = Convert.ToInt32(inputData[9]);
//        statPerLevel[6] = Convert.ToInt32(inputData[10]);
//        statPerLevel[7] = Convert.ToInt32(inputData[11]);
//        statPerLevel[8] = Convert.ToInt32(inputData[12]);
//    }
//    public _Temp_Table_ItemStat(_Temp_Table_ItemStat src)
//    {
//        num = src.num;
//        statPerLevel = src.statPerLevel;
//    }
//}
